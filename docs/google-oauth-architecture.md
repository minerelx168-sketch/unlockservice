...
The audience is External and remains in Testing. Branding is saved as `iUnlockMobile` with home page `https://iunlockmobile.com`, privacy policy `https://iunlockmobile.com/privacy`, terms `https://iunlockmobile.com/terms`, authorized domain `iunlockmobile.com`, and support/developer contact `rmandzor@gmail.com`. The account `rmandzor@gmail.com` is the sole Test user. The app must not be published to all Google users without explicit user approval.
