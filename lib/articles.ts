...
const ARTICLES: Article[] = [
  {
    slug: 'walmart-family-mobile-iphone-unlock-guide',
    title: 'Walmart Family Mobile iPhone Unlock',
    heading: 'Walmart Family Mobile iPhone Unlock: Policy Guide',
    description: 'Need a Walmart Family Mobile iPhone unlock? Check the policy owner, device status and eligibility, then verify the result safely.',
    standfirst: 'The useful path is to identify who sold the iPhone, check the device-specific status and keep the request tied to the correct IMEI.',
    published: '2026-09-26',
    updated: '2026-09-26',
    minutes: 9,
    topic: 'Walmart Family Mobile iPhone unlock',
    blocks: [
      { kind: 'p', text: 'A Walmart Family Mobile iPhone unlock is not decided by the logo on a current SIM. The first question is whether Family Mobile sold and locked the iPhone, or whether the device arrived through bring-your-own-phone service. Family Mobile’s current help route starts by checking the device record and directs eligible devices to its official unlocking process.', links: [{ label: 'Open Family Mobile’s device-unlock instructions', href: 'https://support.myfamilymobile.com/en/brands/General/WFMaccounthelp/faq/3099343/' }] },
      { kind: 'h2', id: 'key-takeaways', text: 'Key Takeaways' },
      { kind: 'list', items: [
        'Identify the original seller before asking Family Mobile to change Carrier Lock.',
        'Check the device-specific status; a general account history does not prove that one IMEI is eligible.',
        'Paying full price and meeting the current unlock policy are separate questions.',
        'For an iPhone, verify the finished result in Settings as No SIM restrictions.',
        'Carrier unlocking does not remove a passcode, SIM PIN, Activation Lock, blacklist or finance obligation.',
      ] },
      { kind: 'h2', id: 'find-policy-owner', text: 'First, find who controls the carrier lock' },
      { kind: 'p', text: 'A phone used on Family Mobile may still carry a restriction from another seller. Family Mobile’s support flow tells users to start with the carrier where the phone was originally purchased. If AT&T, T-Mobile, Verizon, Apple or another retailer supplied the device, preserve that purchase and activation history instead of assuming Family Mobile owns the lock.', links: [{ label: 'See the official Family Mobile status flow', href: 'https://support.myfamilymobile.com/en/brands/General/WFMaccounthelp/faq/3099343/' }, { label: 'Understand how a carrier lock differs from service', href: '/articles/network-unlock-explained' }] },
      { kind: 'table', head: ['How the iPhone reached you', 'Likely first contact', 'Record to prepare'], rows: [
        ['Bought from Family Mobile', 'Family Mobile unlock support', 'Order, activation record and current IMEI'],
        ['Brought from another carrier', 'The original carrier or retailer', 'Original receipt and previous account history'],
        ['Bought unlocked from Apple', 'Apple receipt, then the carrier shown by the lock history', 'Receipt and Carrier Lock screenshot'],
        ['Warranty or insurance replacement', 'The organization that mapped the replacement', 'Both original and replacement IMEIs'],
        ['Bought second-hand', 'Seller and original carrier', 'Purchase proof, status evidence and return deadline'],
      ] },
      { kind: 'note', text: 'Keep the full IMEI, account PIN, passwords, one-time codes and identity documents private. Share them only through an authenticated support route that needs them.' },
      { kind: 'h3', id: 'check-iphone-status', text: 'Check the iPhone status before requesting anything' },
      { kind: 'p', text: 'On the iPhone, open Settings, General, About and find Carrier Lock. Apple says No SIM restrictions means the iPhone is carrier-unlocked. A locked result confirms that a carrier restriction remains, but it does not by itself name the policy owner or the missing eligibility condition.', links: [{ label: 'Follow Apple’s current carrier-unlock guidance', href: 'https://support.apple.com/en-us/109316' }, { label: 'Compare reliable iPhone unlock checks', href: '/articles/how-to-check-if-iphone-is-unlocked' }] },
      { kind: 'h2', id: 'eligibility-records', text: 'Build the eligibility record around the IMEI' },
      { kind: 'p', text: 'Family Mobile’s account-help page separates locked, eligible and unlocked states. It also sends branded iPhone questions to the shared official unlocking policy. Use those live routes for the final decision because eligibility can depend on the device record and policy version; do not copy a waiting period from an old forum post or a different brand.', links: [{ label: 'Review Family Mobile’s iPhone unlock answer', href: 'https://support.myfamilymobile.com/en/brands/General/WFMaccounthelp/faq/3091655/' }, { label: 'Check the current official unlocking policy', href: 'https://www.tfwunlockpolicy.com/wps/portal/home' }] },
      { kind: 'table', head: ['Record', 'What it can establish', 'What it cannot establish alone'], rows: [
        ['Original order or receipt', 'Seller, date and sometimes IMEI', 'That the current policy is satisfied'],
        ['Activation or service history', 'When this device joined the account', 'That an unlock request was submitted'],
        ['Payment or final bill record', 'Whether a balance was cleared', 'That Carrier Lock has changed'],
        ['Replacement paperwork', 'Why the account and current IMEI differ', 'That the replacement was mapped correctly'],
        ['Case reference', 'Which request support reviewed', 'That the update has reached the iPhone'],
      ] },
      { kind: 'h3', id: 'full-price-not-finished', text: 'Full price is not the same as an unlocked result' },
      { kind: 'p', text: 'Family Mobile has a specific FAQ for devices bought at full price and still tells users to check the official eligibility route. Treat payment, eligibility, request submission and completion as four separate checkpoints. Ask support to identify the exact status for the current IMEI instead of assuming the purchase price settles every condition.', links: [{ label: 'Read Family Mobile’s full-price FAQ', href: 'https://support.myfamilymobile.com/en/brands/General/WFMaccounthelp/faq/3091661/' }] },
      { kind: 'h2', id: 'request-steps', text: 'How to handle a Family Mobile iPhone unlock request' },
      { kind: 'list', ordered: true, items: [
        'Record the Carrier Lock result, model and IMEI privately.',
        'Confirm where the iPhone was originally sold and first activated.',
        'Collect the matching order, activation, payment and replacement records.',
        'Use Family Mobile’s current status and eligibility route if it owns the device record.',
        'Ask whether the device is locked, ineligible, eligible, submitted or completed.',
        'Keep the case reference and confirm which IMEI or IMEI2 was reviewed.',
        'After approval, keep the iPhone online, restart it and check Carrier Lock again.',
      ] },
      { kind: 'p', text: 'Apple states that only the carrier can authorize an iPhone carrier unlock. A third-party service may help identify the carrier, organize records or support a legitimate request, but it cannot create eligibility, bypass an account requirement or guarantee approval.', links: [{ label: 'See what an IMEI unlock service can and cannot do', href: '/articles/imei-unlock-iphone-service-checklist' }] },
      { kind: 'h2', id: 'status-troubleshooting', text: 'Troubleshoot the exact status, not the word locked' },
      { kind: 'table', head: ['Status or symptom', 'Likely meaning', 'Best next question'], rows: [
        ['No Family Mobile device record', 'It may be BYOD, second-hand or a replacement', 'Who originally sold or mapped this IMEI?'],
        ['Locked and not eligible', 'A current policy condition is not satisfied', 'Which condition applies to this device today?'],
        ['Eligible', 'A request can proceed, but completion is not proven', 'Was the request submitted, and what is the reference?'],
        ['Completed, but SIM locked remains', 'The wrong identifier may have been handled or the update has not reached the phone', 'Which IMEI was approved, and should the case be escalated?'],
        ['No SIM restrictions, but new service fails', 'Carrier Lock is no longer the likely problem', 'Is the new line compatible and provisioned for this IMEI or IMEI2?'],
      ] },
      { kind: 'h3', id: 'different-locks', text: 'Do not send every lock message to carrier support' },
      { kind: 'p', text: 'Carrier Lock limits which mobile networks can activate the iPhone. A SIM PIN or PUK protects a SIM and comes from the SIM issuer. The passcode protects local access. Activation Lock protects Apple Account ownership. A blacklist or unpaid balance is a separate device or account record. A Family Mobile carrier unlock does not erase any of those other controls.', links: [{ label: 'Route SIM PIN and carrier-lock messages correctly', href: '/articles/sim-locked-iphone-carrier-lock-or-sim-pin' }, { label: 'Review legitimate Activation Lock steps', href: '/articles/iphone-locked-to-owner-legitimate-fixes' }] },
      { kind: 'h2', id: 'verify-completion', text: 'Verify completion before buying another plan' },
      { kind: 'p', text: 'After Family Mobile confirms completion, check Settings, General, About again. Save a screenshot showing No SIM restrictions without exposing the IMEI. Then confirm that the destination carrier supports the iPhone model and can provision its physical SIM or eSIM. Unlock approval does not guarantee coverage, radio compatibility or account activation.', links: [{ label: 'Troubleshoot service after an unlock', href: '/articles/iphone-unlocked-but-no-service-troubleshooting' }] },
      { kind: 'cta', text: 'Need help identifying the policy owner or organizing an existing carrier-unlock case?', href: '/contact', label: 'Contact iUnlockMobile' },
    ],
    faq: [
      { question: 'Can Family Mobile unlock an iPhone brought from another carrier?', answer: 'Usually the organization that originally sold and locked the iPhone controls the request. Family Mobile can help with compatibility and its own device record, but bring-your-own service does not transfer another carrier’s unlock authority.' },
      { question: 'Does paying full price automatically unlock a Family Mobile iPhone?', answer: 'Do not treat payment as proof of completion. Check the current official eligibility route for the exact IMEI, submit any required request and verify No SIM restrictions afterward.' },
      { question: 'Can Apple unlock a Family Mobile iPhone?', answer: 'No. Apple says only the carrier can authorize a carrier unlock. Apple’s Settings screen can show the result, but Apple does not approve the carrier’s eligibility decision.' },
      { question: 'Does a Family Mobile unlock remove Activation Lock or a passcode?', answer: 'No. Carrier Lock, Activation Lock, the screen passcode and SIM PIN or PUK are different controls with different recovery routes.' },
      { question: 'Why does a new SIM fail after No SIM restrictions appears?', answer: 'The new carrier may still need to activate the line, support the model and provision the correct IMEI or IMEI2. Account status, coverage, outages and blacklist records are also separate from Carrier Lock.' },
    ],
  },
  {
    slug: 'sell-locked-iphone-carrier-lock-checklist',
    title: 'Sell a Locked iPhone Safely',
    heading: 'Sell a Locked iPhone: Carrier Lock Checklist',
    description: 'Want to sell a locked iPhone? Identify Carrier Lock, disclose limits, protect buyer and seller, and avoid confusing it with Activation Lock.',
    standfirst: 'A carrier-locked iPhone may still have a buyer, but the listing must name the right restriction and the seller must finish every ownership and privacy step.',
    published: '2026-09-26',
    updated: '2026-09-26',
    minutes: 9,
    topic: 'Sell a locked iPhone',
    blocks: [
      { kind: 'p', text: 'You can sometimes sell a locked iPhone when the buyer or trade-in program accepts carrier-locked devices, but the phrase locked iPhone is too vague for a safe listing. First determine whether the phone has Carrier Lock, Activation Lock, a passcode, SIM PIN, blacklist report or unresolved finance. Those conditions are not interchangeable and do not have the same remedy or value.' },
      { kind: 'h2', id: 'key-takeaways', text: 'Key Takeaways' },
      { kind: 'list', items: [
        'State the exact Carrier Lock status and original carrier before accepting payment.',
        'Do not advertise an unlock as guaranteed when the carrier has not completed it.',
        'Clear personal data and Activation Lock using Apple’s official sale-preparation steps.',
        'Disclose finance, blacklist, repair and replacement history that can affect later use.',
        'Keep a dated receipt and status evidence for both seller and buyer.',
      ] },
      { kind: 'h2', id: 'identify-lock', text: 'Identify what locked means before listing the iPhone' },
      { kind: 'p', text: 'Open Settings, General, About and find Carrier Lock. Apple says No SIM restrictions means the iPhone is carrier-unlocked. If a restriction remains, record the original carrier and do not describe the device as unlocked. This check says nothing about Apple Account ownership, passcode access, blacklist status or a remaining device balance.', links: [{ label: 'Use Apple’s current Carrier Lock check', href: 'https://support.apple.com/en-us/109316' }, { label: 'Follow the complete iPhone unlock-status guide', href: '/articles/how-to-check-if-iphone-is-unlocked' }] },
      { kind: 'table', head: ['Condition', 'What it affects', 'Before a sale'], rows: [
        ['Carrier Lock', 'Which mobile networks can activate the iPhone', 'Name the carrier and request an official unlock if eligible'],
        ['Activation Lock', 'Whether a new owner can set up the iPhone', 'Sign out, erase correctly and remove it from your account'],
        ['Screen passcode', 'Access to data on the device', 'Back up, erase and never share the passcode with a buyer'],
        ['SIM PIN or PUK', 'Use of the installed SIM or eSIM line', 'Remove your line; ask its issuer for SIM recovery'],
        ['Blacklist report', 'Whether networks may provide service', 'Resolve the report with the reporting carrier; do not call it a carrier unlock'],
        ['Finance balance', 'The seller’s contract and possible eligibility', 'Settle or accurately disclose the obligation under the applicable terms'],
      ] },
      { kind: 'note', text: 'A carrier unlock does not prove that an iPhone is paid off, clean, compatible, free of Activation Lock or ready for every network.' },
      { kind: 'h3', id: 'carrier-lock-vs-activation-lock', text: 'Carrier Lock and Activation Lock are not the same sale condition' },
      { kind: 'p', text: 'Carrier Lock affects cellular activation. Activation Lock is Apple’s ownership protection linked to Find My and the seller’s Apple Account. Apple’s current sale checklist says to back up, sign out, erase the device and remove it from trusted devices; erasing correctly also turns off Find My and Activation Lock. A carrier cannot remove the previous owner’s Activation Lock as part of a SIM unlock.', links: [{ label: 'Follow Apple’s before-you-sell checklist', href: 'https://support.apple.com/en-us/109511' }, { label: 'Use legitimate Locked to Owner steps', href: '/articles/iphone-locked-to-owner-legitimate-fixes' }] },
      { kind: 'h2', id: 'unlock-before-sale', text: 'Should you unlock the iPhone before selling it?' },
      { kind: 'p', text: 'An official carrier unlock can widen the pool of compatible buyers, but request it only through a legitimate path and only if the device qualifies. Apple says it cannot approve the change; only the carrier can unlock the iPhone. If approval is pending, list the current locked status rather than promising a future outcome.', links: [{ label: 'Read Apple’s carrier-unlock process', href: 'https://support.apple.com/en-us/109316' }, { label: 'Check carrier-unlock eligibility factors', href: '/articles/iphone-carrier-unlock-eligibility' }] },
      { kind: 'table', head: ['Carrier response', 'How to describe the iPhone', 'Seller action'], rows: [
        ['No SIM restrictions', 'Carrier-unlocked, subject to compatibility', 'Save status evidence and verify the listing details'],
        ['Locked but eligible', 'Currently carrier-locked; request may be available', 'Submit the official request before promising anything'],
        ['Request submitted', 'Carrier-locked while approval is pending', 'Keep the case reference and wait for completion'],
        ['Not eligible', 'Locked to the named carrier', 'State the restriction and do not sell an unlock guarantee'],
        ['Status unknown', 'Carrier status not verified', 'Do not guess; identify the original carrier and check first'],
      ] },
      { kind: 'h3', id: 'third-party-role', text: 'What a third-party unlock service can actually do' },
      { kind: 'p', text: 'A third party may identify the original carrier, explain a report or help organize an authorized request. It cannot make false ownership records valid, clear an account balance, remove a lost-or-stolen report or guarantee that a carrier will approve the IMEI. Read the deliverable and refund terms before paying for help.', links: [{ label: 'Evaluate an iPhone unlock service before ordering', href: '/articles/imei-unlock-iphone-service-checklist' }] },
      { kind: 'h2', id: 'seller-checklist', text: 'Seller checklist: document, disclose, then erase' },
      { kind: 'list', ordered: true, items: [
        'Record the model, storage, IMEI privately, Carrier Lock result and original carrier.',
        'Check whether a device balance, replacement record or blacklist report could affect service.',
        'Request an official carrier unlock if the iPhone is eligible and time permits.',
        'Recheck Carrier Lock after the carrier confirms completion.',
        'Back up and transfer your personal information before deleting anything.',
        'Unpair an Apple Watch, sign out of the Apple Account and erase all content and settings.',
        'Remove or transfer the physical SIM and choose the appropriate eSIM erase option.',
        'Give the buyer a dated receipt with the serial or partially masked IMEI and all disclosed conditions.',
      ] },
      { kind: 'p', text: 'Apple warns that manually deleting synced data while still signed in can also remove it from iCloud and connected devices. Follow the official erase sequence instead. If the iPhone uses eSIM, Apple specifically includes an option to erase the device and eSIM profile during the sale process.', links: [{ label: 'Review Apple’s latest transfer and erase steps', href: 'https://support.apple.com/en-us/109511' }] },
      { kind: 'h2', id: 'write-listing', text: 'Write a listing that a buyer can verify' },
      { kind: 'table', head: ['Listing field', 'Useful wording', 'Avoid'], rows: [
        ['Carrier Lock', 'Locked to [carrier] or No SIM restrictions shown', 'Unlocked for every carrier'],
        ['Unlock request', 'Request pending; current status remains locked', 'Guaranteed to unlock later'],
        ['Ownership setup', 'Will be erased and removed from seller’s Apple Account', 'Easy iCloud bypass'],
        ['Network status', 'Blacklist check dated [date], source named', 'Clean forever'],
        ['Compatibility', 'Buyer should confirm model support with their carrier', 'Works anywhere'],
        ['Finance', 'Paid off or balance disclosed based on current records', 'No issues without evidence'],
      ] },
      { kind: 'h3', id: 'protect-both-sides', text: 'Protect both sides at handoff' },
      { kind: 'p', text: 'Let the buyer compare the IMEI in Settings with the receipt, inspect Carrier Lock and reach the setup screen after erasure. Do not send public photos of the full IMEI, and do not share account credentials or one-time codes. A marketplace’s acceptance and disclosure rules can differ, so check the current terms of the actual selling channel before listing.' },
      { kind: 'h2', id: 'buyer-cannot-fix', text: 'Do not transfer an account-only problem to the buyer' },
      { kind: 'p', text: 'A buyer usually cannot recreate your purchase, payoff or replacement history. Resolve carrier eligibility and ownership records while you still control the account. If the iPhone is blacklisted, use the carrier or reporter that placed the record rather than presenting a carrier unlock as the solution.', links: [{ label: 'See what carrier unlocking cannot fix on a blacklisted iPhone', href: '/articles/blacklisted-iphone-unlock-carrier-lock-difference' }, { label: 'Compare checks buyers should run', href: '/articles/checks-before-buying-a-used-phone' }] },
      { kind: 'cta', text: 'Need help identifying the carrier restriction before you list or trade in the iPhone?', href: '/contact', label: 'Contact iUnlockMobile' },
    ],
    faq: [
      { question: 'Can you sell a carrier-locked iPhone?', answer: 'Sometimes, if the buyer or trade-in program accepts it and the restriction is accurately disclosed. State the original carrier and current status, and check the selling channel’s current rules.' },
      { question: 'Is a carrier-locked iPhone the same as an iCloud-locked iPhone?', answer: 'No. Carrier Lock limits cellular networks. Activation Lock is tied to the previous owner’s Apple Account and can prevent a new owner from setting up the device.' },
      { question: 'Should I promise the buyer that the iPhone will unlock later?', answer: 'No. Until Settings shows No SIM restrictions, describe the iPhone as locked or pending. Only the carrier can approve the request, and eligibility can change with the device or account record.' },
      { question: 'Does erasing the iPhone remove Carrier Lock?', answer: 'No. Erasing protects your data and can turn off Find My and Activation Lock when done correctly, but Carrier Lock remains until the responsible carrier authorizes an unlock.' },
      { question: 'What proof should I give the buyer?', answer: 'Provide a dated receipt, model and serial or partially masked IMEI, the disclosed Carrier Lock status, and any legitimate unlock confirmation. Keep full account credentials, PINs and one-time codes private.' },
    ],
  },
  {
    slug: 'consumer-cellular-iphone-unlock-eligibility',
    title: 'Consumer Cellular iPhone Unlock',
    heading: 'Consumer Cellular iPhone Unlock: Eligibility Checklist',
    description: 'Need a Consumer Cellular iPhone unlock? Identify the policy owner, prepare device records, request review and verify Carrier Lock safely.',
    standfirst: 'The correct path depends on whether Consumer Cellular sold the iPhone or accepted it as a bring-your-own device, plus the record attached to its IMEI.',
    published: '2026-09-25',
    updated: '2026-09-25',
    minutes: 9,
    topic: 'Consumer Cellular iPhone unlock',
    blocks: [
      { kind: 'p', text: 'A Consumer Cellular iPhone unlock begins with one question: who originally sold and locked the device? An iPhone bought from Consumer Cellular may have a Consumer Cellular eligibility record. An unlocked or carrier-locked iPhone brought to its service keeps the unlock history of the original seller.', links: [{ label: 'Open Consumer Cellular’s current device-unlock help', href: 'https://www.consumercellular.com/help/phones-and-services/common-issues-and-fixes/can-consumer-cellular-unlock-my-device' }] },
      { kind: 'h2', id: 'key-takeaways', text: 'Key Takeaways' },
      { kind: 'list', items: [
        'Confirm the original seller before asking Consumer Cellular to change Carrier Lock.',
        'Bringing an iPhone to Consumer Cellular does not transfer another carrier’s unlock authority.',
        'Paid off, eligible, request submitted and No SIM restrictions are different checkpoints.',
        'Use the current device-specific support decision instead of relying on an old waiting-period answer.',
        'Verify the result in Settings before buying another carrier’s SIM, eSIM or travel plan.',
      ] },
      { kind: 'h2', id: 'identify-policy-owner', text: 'Identify who controls the iPhone lock' },
      { kind: 'p', text: 'The carrier shown in the status bar does not prove who controls Carrier Lock. Build a short history of the sale, first activation and any replacement. Consumer Cellular’s own guidance says a locked phone remains tied to the carrier that sold it until it is officially unlocked, and it advises contacting that carrier about eligibility.', links: [{ label: 'Read Consumer Cellular’s locked-versus-unlocked guide', href: 'https://www.consumercellular.com/blog/how-to-tell-if-your-phone-is-unlocked/' }] },
      { kind: 'table', head: ['Device history', 'Start with', 'Evidence to keep'], rows: [
        ['Bought from Consumer Cellular', 'Consumer Cellular device-unlock support', 'Order, activation and account records tied to the IMEI'],
        ['Brought to Consumer Cellular from another carrier', 'The original carrier or retailer', 'Original receipt and previous account history'],
        ['Bought unlocked from Apple or another retailer', 'Verify status, then destination-carrier activation', 'Receipt, model number and Carrier Lock screenshot'],
        ['Warranty or insurance replacement', 'The carrier or fulfiller that mapped the replacement', 'Document connecting the original and replacement IMEIs'],
        ['Bought second-hand', 'The seller and original carrier', 'Redacted purchase proof, current status and return deadline'],
      ] },
      { kind: 'note', text: 'Keep the full IMEI, account PIN, password, one-time codes and identity documents private. Share them only through an authenticated support channel that needs them.' },
      { kind: 'h3', id: 'check-carrier-lock', text: 'Check Carrier Lock before opening a request' },
      { kind: 'p', text: 'Open Settings, General, About and find Carrier Lock. Apple and Consumer Cellular both describe No SIM restrictions as the unlocked result. If the field says SIM locked or Carrier locked, a carrier restriction remains. This screen confirms status but does not identify the policy owner or missing requirement.', links: [{ label: 'Follow Apple’s current iPhone unlock guidance', href: 'https://support.apple.com/en-us/109316' }, { label: 'Compare reliable iPhone unlock checks', href: '/articles/how-to-check-if-iphone-is-unlocked' }] },
      { kind: 'h2', id: 'prepare-eligibility-records', text: 'Prepare the eligibility records' },
      { kind: 'p', text: 'Consumer Cellular’s general guide mentions common carrier checks such as whether a phone is paid off, the account is in good standing and the device has qualifying activity. It does not replace the current device-specific policy decision. Ask support to name the exact condition applied to the IMEI rather than importing a timeline from another carrier or an old forum answer.', links: [{ label: 'Review Consumer Cellular’s current guidance', href: 'https://www.consumercellular.com/blog/how-to-tell-if-your-phone-is-unlocked/' }] },
      { kind: 'table', head: ['Record', 'What it helps establish', 'What it cannot prove alone'], rows: [
        ['Original receipt or order', 'Seller, purchase date and sometimes IMEI', 'When qualifying service began'],
        ['Activation record', 'Which carrier first activated the device', 'That every later eligibility condition was met'],
        ['Payoff or final bill', 'Whether the device balance was cleared', 'That a carrier unlock was submitted or completed'],
        ['Account history', 'The line and device relationship', 'That a replacement IMEI was mapped correctly'],
        ['Case reference', 'Which request and IMEI support reviewed', 'That the iPhone has received the update'],
      ] },
      { kind: 'h3', id: 'byod-record', text: 'A bring-your-own iPhone follows its original lock record' },
      { kind: 'p', text: 'Consumer Cellular may activate a compatible phone without controlling its carrier lock. If the iPhone arrived from AT&T, T-Mobile, Verizon or another seller, that organization’s policy may still govern it. Ask Consumer Cellular to confirm compatibility and provisioning, but send an unlock request to the carrier that owns the restriction.', links: [{ label: 'See how a network lock differs from service activation', href: '/articles/network-unlock-explained' }] },
      { kind: 'h2', id: 'request-steps', text: 'How to request a Consumer Cellular iPhone unlock' },
      { kind: 'list', ordered: true, items: [
        'Record the exact Carrier Lock result, model and full IMEI privately.',
        'Confirm where the iPhone was bought and which carrier first activated it.',
        'Gather the order, activation, payoff and replacement records that match the device.',
        'Use Consumer Cellular’s current device-unlock help route if it sold or locked the iPhone.',
        'Ask whether the status is ineligible, eligible, submitted or completed and which condition remains.',
        'Keep the case reference and confirm that support reviewed the current IMEI or IMEI2.',
        'After completion, keep the iPhone online, restart it and check Carrier Lock again.',
      ] },
      { kind: 'p', text: 'Apple states that it cannot unlock an iPhone for another carrier and that only the carrier can authorize the change. A third-party service may help organize records or support an available carrier process, but it cannot create eligibility, impersonate an account holder or guarantee approval.', links: [{ label: 'Review what an IMEI unlock service can do', href: '/articles/imei-unlock-iphone-service-checklist' }] },
      { kind: 'h2', id: 'status-troubleshooting', text: 'Troubleshoot the request by status' },
      { kind: 'table', head: ['Status or problem', 'What it may mean', 'Best next question'], rows: [
        ['No device record', 'The phone may be BYOD, second-hand or a replacement', 'Which carrier owns the original or replacement record?'],
        ['Paid off but not eligible', 'Balance and unlock eligibility are separate checks', 'Which exact current-policy condition remains?'],
        ['Eligible', 'The device can proceed, but no completed request is proven', 'Was the request submitted and what is its reference?'],
        ['Completed, but SIM locked remains', 'The wrong IMEI may have been handled or the update has not reached the phone', 'Which identifier was approved and should the case be escalated?'],
        ['No SIM restrictions, but the new line fails', 'Carrier Lock is no longer the likely cause', 'Is the line active, compatible and provisioned for this IMEI or IMEI2?'],
      ] },
      { kind: 'h3', id: 'used-iphone', text: 'If you bought the Consumer Cellular iPhone used' },
      { kind: 'p', text: 'Keep return and payment protection open while the seller provides a redacted original receipt and handles account-only requirements. A buyer usually cannot recreate missing ownership, payoff or replacement history. Do not pay an unexplained balance based only on a promise that the device will unlock.', links: [{ label: 'Use the complete used-iPhone checklist', href: '/articles/checks-before-buying-a-used-phone' }] },
      { kind: 'h3', id: 'travel', text: 'If you need the iPhone unlocked for travel' },
      { kind: 'p', text: 'Begin before purchasing a travel eSIM. Eligibility is not the same as completion, and another eSIM cannot bypass Carrier Lock. If approval is not complete before departure, compare roaming or use a separate unlocked phone.', links: [{ label: 'Follow the pre-travel iPhone checklist', href: '/articles/unlock-iphone-for-international-use-travel-checklist' }] },
      { kind: 'h2', id: 'different-restrictions', text: 'Know what a carrier unlock will not fix' },
      { kind: 'list', items: [
        'A SIM PIN or PUK protects one SIM or eSIM and is handled by that line’s issuer.',
        'A forgotten passcode controls access to the iPhone, not carrier eligibility.',
        'iPhone Locked to Owner is Activation Lock tied to an Apple Account.',
        'A lost, stolen or fraud-related IMEI block requires the responsible record owner.',
        'An unlocked model can still be incompatible or incorrectly provisioned on another network.',
      ] },
      { kind: 'cta', text: 'Have the original seller, activation record, Carrier Lock result and official case status? Send a redacted summary and ask whether a relevant iUnlockMobile service is currently available before ordering.', href: '/contact', label: 'Check service availability' },
    ],
    faq: [
      { question: 'How do I unlock a Consumer Cellular iPhone?', answer: 'Confirm Consumer Cellular sold or controls the device, gather the matching order and activation records, contact its current unlock support and verify No SIM restrictions after completion.' },
      { question: 'Can Consumer Cellular unlock a bring-your-own iPhone?', answer: 'Usually the original carrier or seller controls a BYOD carrier lock. Consumer Cellular can confirm compatibility and activation, but moving the line does not transfer another carrier’s unlock authority.' },
      { question: 'Is a paid-off Consumer Cellular iPhone automatically unlocked?', answer: 'Do not assume so. Payoff is one checkpoint. Confirm device-specific eligibility, request status and the Carrier Lock result in Settings.' },
      { question: 'Why does support say completed while the iPhone says SIM locked?', answer: 'Confirm that support approved the current IMEI, keep the iPhone online, restart it and return to the same case if Carrier Lock does not update.' },
      { question: 'Can an unlock service guarantee Consumer Cellular approval?', answer: 'No legitimate service can guarantee a carrier decision or manufacture missing eligibility. It should state the exact assistance, limitations and refund terms before payment.' },
    ],
  },
  {
    slug: 'simple-mobile-iphone-unlock-policy-status',
    title: 'Simple Mobile iPhone Unlock Guide',
    heading: 'Simple Mobile iPhone Unlock: Policy and Status Guide',
    description: 'Need a Simple Mobile iPhone unlock? Match the current policy to the device record, submit the right request and verify Carrier Lock afterward.',
    standfirst: 'Simple Mobile publishes separate answers for policy, early requests and processing, so the device’s sale, activation and current policy version all matter.',
    published: '2026-09-25',
    updated: '2026-09-25',
    minutes: 9,
    topic: 'Simple Mobile iPhone unlock',
    blocks: [
      { kind: 'p', text: 'A Simple Mobile iPhone unlock should be based on the current policy attached to the device record. Simple Mobile’s support catalog separates the policy, request method, early-unlock questions and processing time into different answers. Treat those as different checkpoints rather than assuming one old timeline applies to every iPhone.', links: [{ label: 'Open Simple Mobile’s current unlock instructions', href: 'https://support.simplemobile.com/en/brands/General/SMaccounthelp/faq/2846326/' }, { label: 'Review the official Simple Mobile policy answer', href: 'https://support.simplemobile.com/en/brands/General/SMaccounthelp/faq/3087267/' }] },
      { kind: 'h2', id: 'key-takeaways', text: 'Key Takeaways' },
      { kind: 'list', items: [
        'Confirm Simple Mobile sold and activated the iPhone before applying its unlock policy.',
        'Purchase date, activation, qualifying service, eligibility, request and completion are separate facts.',
        'A policy version or cutoff can change which rule applies to an older device record.',
        'An iPhone does not use a generic network-unlock code; the carrier must authorize the status change.',
        'Verify No SIM restrictions before paying for another carrier’s SIM, eSIM or travel service.',
      ] },
      { kind: 'h2', id: 'identify-policy-owner', text: 'Confirm Simple Mobile controls the carrier lock' },
      { kind: 'p', text: 'Start with the original sale and first activation. A Simple Mobile SIM inside an iPhone does not prove that Simple Mobile locked it. A bring-your-own device may still be governed by another carrier or retailer, while a replacement may need its IMEI linked to the original qualifying record.' },
      { kind: 'table', head: ['Device history', 'Likely starting point', 'Evidence to keep'], rows: [
        ['Bought from Simple Mobile and activated there', 'Simple Mobile unlock support', 'Order, activation and service records tied to the IMEI'],
        ['Brought to Simple Mobile from another carrier', 'The original carrier or retailer', 'Original receipt and prior account history'],
        ['Replacement or warranty device', 'The organization that issued the replacement', 'Old-to-new IMEI mapping and replacement date'],
        ['Bought second-hand', 'The seller and original policy owner', 'Redacted receipt, Carrier Lock screen and return deadline'],
      ] },
      { kind: 'note', text: 'Do not publish a full IMEI, account PIN, password, one-time code or unredacted identity document. Use an authenticated carrier channel when sensitive details are required.' },
      { kind: 'h3', id: 'check-carrier-lock', text: 'Read Carrier Lock before requesting anything' },
      { kind: 'p', text: 'Open Settings, General, About and find Carrier Lock. Apple says No SIM restrictions means the iPhone is unlocked. If it says SIM locked, the carrier restriction remains. This field confirms the result but does not show which Simple Mobile policy version applies or which eligibility condition is missing.', links: [{ label: 'Follow Apple’s current carrier-unlock guidance', href: 'https://support.apple.com/en-us/109316' }, { label: 'Check whether an iPhone is unlocked', href: '/articles/how-to-check-if-iphone-is-unlocked' }] },
      { kind: 'h2', id: 'match-current-policy', text: 'Match the current policy to the device record' },
      { kind: 'p', text: 'The official support results include separate pages for whether Simple Mobile has an unlocking policy, whether a phone can be unlocked immediately after purchase and what happens with an early request. Because those pages are delivered dynamically and may change, use the live policy response for the IMEI instead of copying a number from an archived answer.', links: [{ label: 'Review the current central unlocking policy', href: 'https://www.tfwunlockpolicy.com/wps/portal/home' }, { label: 'See Simple Mobile’s early-request support topic', href: 'https://support.simplemobile.com/en/brands/General/SMaccounthelp/faq/2846324/' }] },
      { kind: 'table', head: ['Record', 'What it helps establish', 'What it cannot prove alone'], rows: [
        ['Purchase record', 'Seller, date and sometimes device identifier', 'The policy starting event'],
        ['Activation confirmation', 'When the device entered Simple Mobile’s system', 'That every later service condition counted'],
        ['Paid-service history', 'Which periods the account records as qualifying service', 'That an unlock request was submitted'],
        ['Replacement mapping', 'Why the active IMEI differs from the original phone', 'That every status transferred correctly'],
        ['Request reference', 'Which IMEI and policy support reviewed', 'That Apple’s activation system has already updated'],
      ] },
      { kind: 'h3', id: 'calendar-vs-service', text: 'Do not confuse calendar age with qualifying service' },
      { kind: 'p', text: 'A phone can be old without having the activation or paid-service history required by its current policy. Ask Simple Mobile which event started the policy calculation, whether any inactive period counts and which policy version controls the IMEI. Record the answer and case reference so a later review uses the same facts.' },
      { kind: 'h2', id: 'request-steps', text: 'How to request a Simple Mobile iPhone unlock' },
      { kind: 'list', ordered: true, items: [
        'Record the exact Carrier Lock result, iPhone model and full IMEI privately.',
        'Confirm the original seller, first activation brand and whether the device was brought from elsewhere.',
        'Gather the order, activation, paid-service and replacement records matching the phone.',
        'Use Simple Mobile’s official unlock instructions and current policy route for the IMEI.',
        'If the result is unclear, ask which policy version applies and which exact condition remains.',
        'Keep the case reference and ask whether the status is ineligible, eligible, submitted or completed.',
        'After completion, connect the iPhone, restart it and check Carrier Lock again.',
      ] },
      { kind: 'p', text: 'Apple says only the carrier can unlock an iPhone and that carrier processing can take time. Apple does not provide a generic code or approve eligibility. After carrier confirmation, a new physical SIM can trigger activation, while a destination carrier must provide and provision its own eSIM.', links: [{ label: 'Review Apple’s post-approval steps', href: 'https://support.apple.com/en-us/109316' }] },
      { kind: 'h2', id: 'status-troubleshooting', text: 'Troubleshoot the request by status' },
      { kind: 'table', head: ['Status or problem', 'What it may mean', 'Best next action'], rows: [
        ['No matching device', 'The IMEI may be BYOD, from another brand or a replacement', 'Identify the original sale and map any replacement IMEI'],
        ['Not eligible', 'A current-policy condition is not satisfied', 'Ask for the named condition, policy version and starting event'],
        ['Eligible', 'The device may proceed, but submission is not proven', 'Request the submission and case reference'],
        ['Request submitted', 'Carrier processing is pending', 'Use the same case and official processing-status answer'],
        ['Completed, but SIM locked remains', 'The wrong IMEI may have been handled or the update has not reached the iPhone', 'Confirm the approved identifier and escalate the existing case'],
        ['No SIM restrictions, but no service', 'Unlock is complete; the destination line has another problem', 'Check activation, compatibility, account and IMEI provisioning'],
      ] },
      { kind: 'p', text: 'Simple Mobile publishes a separate processing-time answer, which reinforces that submission and completion are not the same event. Avoid opening duplicate requests while one case is pending; keep the original reference and ask for a status tied to that IMEI.', links: [{ label: 'Open Simple Mobile’s processing-time answer', href: 'https://support.simplemobile.com/en/brands/General/SMaccounthelp/faq/2846328/' }] },
      { kind: 'h3', id: 'used-iphone', text: 'If you bought the Simple Mobile iPhone used' },
      { kind: 'p', text: 'Keep buyer protection open while the seller provides a redacted receipt and resolves any account-only requirement. Do not impersonate the original account holder or pay an unexplained balance in exchange for an unlock promise. If the seller cannot establish the original record, use the return or dispute route before its deadline.', links: [{ label: 'Use the used-phone buying checklist', href: '/articles/checks-before-buying-a-used-phone' }] },
      { kind: 'h3', id: 'travel', text: 'If you need a travel SIM or eSIM' },
      { kind: 'p', text: 'Do not treat an eligible or submitted status as a completed unlock. Verify No SIM restrictions first, then confirm the destination carrier accepts the exact iPhone model and can provision the correct IMEI or IMEI2.', links: [{ label: 'Follow the international-use checklist', href: '/articles/unlock-iphone-for-international-use-travel-checklist' }] },
      { kind: 'h2', id: 'different-restrictions', text: 'Know what Simple Mobile unlocking does not change' },
      { kind: 'list', items: [
        'SIM PIN or PUK protects one line and must be handled by that SIM or eSIM issuer.',
        'A forgotten iPhone passcode is a device-access issue, not a carrier policy decision.',
        'Activation Lock is tied to an Apple Account and can show iPhone Locked to Owner.',
        'A blacklist or fraud-related block is separate from Carrier Lock.',
        'Carrier unlock does not guarantee another network’s coverage, bands or account provisioning.',
      ] },
      { kind: 'cta', text: 'Have the original seller, activation history, Carrier Lock result and official Simple Mobile status? Send a redacted summary and ask whether a relevant iUnlockMobile service is currently available before ordering.', href: '/contact', label: 'Check service availability' },
    ],
    faq: [
      { question: 'How do I unlock a Simple Mobile iPhone?', answer: 'Confirm Simple Mobile controls the lock, collect the matching sale and activation records, use its current official request route and verify No SIM restrictions after completion.' },
      { question: 'How long does a Simple Mobile iPhone unlock take?', answer: 'Processing and eligibility depend on the device and current policy. Use Simple Mobile’s live policy and processing answers, keep the case reference and avoid relying on an old fixed timeline.' },
      { question: 'Can Simple Mobile unlock a bring-your-own iPhone?', answer: 'The original carrier or seller usually controls a BYOD carrier lock. Activating Simple Mobile service does not automatically transfer another carrier’s unlock authority.' },
      { question: 'Does an iPhone need a Simple Mobile unlock code?', answer: 'No generic code completes an iPhone carrier unlock. The carrier authorizes the status change, and Settings should eventually show No SIM restrictions.' },
      { question: 'Can a third party guarantee a Simple Mobile unlock?', answer: 'No legitimate service can guarantee carrier approval or create missing qualifying history. Require a clear deliverable, limitations and written refund terms before payment.' },
    ],
  },
  {
    slug: 'tracfone-iphone-unlock-current-policy-checklist',
    title: 'TracFone iPhone Unlock Guide',
    heading: 'TracFone iPhone Unlock: Which Policy Applies?',
    description: 'Need a TracFone iPhone unlock? Identify the policy owner, prepare device records, use the official request route and verify the result.',
    standfirst: 'A reliable request starts with the iPhone’s original sale and activation record, then follows the current TracFone policy attached to that device.',
    published: '2026-09-24',
    updated: '2026-09-24',
    minutes: 9,
    topic: 'TracFone iPhone unlock',
    blocks: [
      { kind: 'p', text: 'A TracFone iPhone unlock should start with the current official device record, not a waiting-period number copied from an old answer. TracFone’s terms link to a live device-unlock policy and say that policy may be updated. Use that route to identify the rule and status that apply to the specific iPhone.', links: [{ label: 'Open the official TracFone device-unlock page', href: 'https://www.tracfone.com/device/device-unlock' }, { label: 'Read the current TracFone terms', href: 'https://www.tracfone.com/terms-and-conditions' }] },
      { kind: 'h2', id: 'key-takeaways', text: 'Key Takeaways' },
      { kind: 'list', items: [
        'Confirm who sold and first activated the iPhone before applying a TracFone policy.',
        'A TracFone SIM in a bring-your-own phone does not transfer another carrier’s unlock authority.',
        'Purchase, activation, service, eligibility, request and completion are different checkpoints.',
        'Use the live official policy for the device instead of assuming an older timeline still applies.',
        'Verify No SIM restrictions in Settings before buying a new SIM, eSIM or travel plan.',
      ] },
      { kind: 'h2', id: 'identify-policy-owner', text: 'Identify who controls the carrier lock' },
      { kind: 'p', text: 'TracFone’s terms distinguish phones sold for TracFone service from a keep-your-own-phone device. The terms say a customer bringing a phone is responsible for ensuring that it is unlocked and compatible. That means the current service brand and the carrier with authority to unlock the iPhone may be different.', links: [{ label: 'Review TracFone’s device and BYOP terms', href: 'https://www.tracfone.com/terms-and-conditions' }] },
      { kind: 'table', head: ['Device history', 'Start with', 'Evidence to keep'], rows: [
        ['Bought from TracFone and activated there', 'TracFone’s current unlock route', 'Order, activation and paid-service records tied to the IMEI'],
        ['Brought to TracFone from another carrier', 'The original carrier or retailer', 'Original receipt and previous carrier account history'],
        ['Warranty or insurance replacement', 'The carrier or fulfiller that mapped the replacement', 'Document connecting the original and replacement IMEIs'],
        ['Bought second-hand', 'The seller plus the carrier shown by the original record', 'Redacted purchase proof, Carrier Lock result and return deadline'],
      ] },
      { kind: 'note', text: 'Keep the full IMEI, account PIN, password, one-time codes and identity documents private. Share sensitive details only through an authenticated carrier channel that needs them.' },
      { kind: 'h3', id: 'check-carrier-lock', text: 'Check Carrier Lock on the iPhone' },
      { kind: 'p', text: 'Open Settings, General, About and find Carrier Lock. Apple says No SIM restrictions means the iPhone is unlocked. If the field says SIM locked, a carrier restriction remains. This confirms the result but does not identify the policy owner or explain an eligibility decision.', links: [{ label: 'Follow Apple’s carrier-unlock guidance', href: 'https://support.apple.com/en-us/109316' }, { label: 'Compare reliable iPhone unlock checks', href: '/articles/how-to-check-if-iphone-is-unlocked' }] },
      { kind: 'h2', id: 'use-current-policy', text: 'Use the current policy for the specific device' },
      { kind: 'p', text: 'TracFone’s published terms point customers to its Device Unlocking Policy and reserve the right to update that policy. The official unlock page loads the current device workflow dynamically, so a fixed number from an archived guide may not describe today’s record. Ask which policy applies, which event starts any required period and what condition remains.', links: [{ label: 'Check the live TracFone unlock workflow', href: 'https://www.tracfone.com/device/device-unlock' }] },
      { kind: 'table', head: ['Record', 'What it helps establish', 'What it cannot prove alone'], rows: [
        ['Original order or receipt', 'Seller, purchase date and sometimes IMEI', 'When qualifying service began'],
        ['Activation confirmation', 'When the device or line entered the carrier system', 'That every later service condition was met'],
        ['Service and payment history', 'How the account was used and maintained', 'That an unlock request exists'],
        ['Replacement confirmation', 'Why the active IMEI differs from the purchased phone', 'That the replacement inherited every status'],
        ['Case or portal reference', 'Which request the carrier reviewed', 'That Carrier Lock has already updated'],
      ] },
      { kind: 'h3', id: 'avoid-old-timelines', text: 'Why an old waiting-period answer can mislead you' },
      { kind: 'p', text: 'A policy can depend on the sale channel, activation date, device type, account history or a transition between policy versions. Do not move the date backward to the purchase day unless the live policy says that is the starting event. Record the policy or case response used for the IMEI so a later review stays anchored to the same facts.' },
      { kind: 'h2', id: 'request-steps', text: 'How to request a TracFone iPhone unlock' },
      { kind: 'list', ordered: true, items: [
        'Record the iPhone model, full IMEI privately and the exact Carrier Lock result.',
        'Confirm the original seller, activation brand and whether the phone was brought from another carrier.',
        'Gather the order, activation, service and replacement records that match the device.',
        'Use TracFone’s official device-unlock page and follow the current instructions for that IMEI.',
        'If the result is ineligible or unclear, ask which policy applies and which exact condition is missing.',
        'Keep the request or case reference and avoid opening duplicate cases with different histories.',
        'After completion, keep the iPhone online, restart it and check Carrier Lock again.',
      ] },
      { kind: 'p', text: 'Apple states that only the carrier can unlock an iPhone for use with another carrier. A third-party service can help organize evidence or support an available carrier process, but it cannot replace carrier authorization, create missing service history or guarantee approval.', links: [{ label: 'See what an IMEI unlock service actually does', href: '/articles/imei-unlock-iphone-service-checklist' }] },
      { kind: 'h2', id: 'status-troubleshooting', text: 'Troubleshoot the request by status' },
      { kind: 'table', head: ['Status or problem', 'What it usually means', 'Best next question'], rows: [
        ['No device record', 'The IMEI may belong to another seller, an old brand record or a replacement', 'Which organization controls the original or replacement IMEI?'],
        ['Not eligible', 'At least one current policy condition is not satisfied', 'Which named condition and starting event apply?'],
        ['Eligible', 'The device may proceed, but approval may not be complete', 'Was a request submitted and what is its reference?'],
        ['Completed, but SIM locked remains', 'The wrong IMEI may have been handled or the update may not have reached the phone', 'Which IMEI was approved, and should the case be escalated?'],
        ['No SIM restrictions, but no service', 'Carrier Lock is no longer the likely cause', 'Is the destination line active, compatible and provisioned for this IMEI or IMEI2?'],
      ] },
      { kind: 'h3', id: 'used-iphone', text: 'If you bought the TracFone iPhone used' },
      { kind: 'p', text: 'Keep return and payment protection open while the seller supplies a redacted original receipt and resolves account-only issues. A buyer usually cannot recreate a missing activation record or act as the original account holder. Do not pay an unexplained account balance in exchange for a promise that the phone will unlock.', links: [{ label: 'Follow the used-iPhone purchase checklist', href: '/articles/checks-before-buying-a-used-phone' }] },
      { kind: 'h3', id: 'travel', text: 'If you need the unlock for international travel' },
      { kind: 'p', text: 'Begin before buying a travel eSIM. An eligibility message is not a completed unlock, and a second eSIM cannot bypass Carrier Lock. If approval is not complete before departure, compare roaming or use a separate unlocked device.', links: [{ label: 'Use the pre-travel iPhone checklist', href: '/articles/unlock-iphone-for-international-use-travel-checklist' }] },
      { kind: 'h2', id: 'different-restrictions', text: 'Know what a TracFone unlock will not fix' },
      { kind: 'list', items: [
        'A SIM PIN or PUK protects one SIM or eSIM and must be handled by that line’s issuer.',
        'A forgotten iPhone passcode is a device-access issue, not a carrier-lock decision.',
        'iPhone Locked to Owner is Activation Lock tied to an Apple Account.',
        'A lost, stolen or fraud-related IMEI block needs the responsible carrier or account process.',
        'An unlocked iPhone can still fail another network’s compatibility or provisioning checks.',
      ] },
      { kind: 'cta', text: 'Have the original seller, activation record, Carrier Lock result and official request status? Send a redacted summary and ask whether a relevant iUnlockMobile service is currently available before ordering.', href: '/contact', label: 'Check service availability' },
    ],
    faq: [
      { question: 'How do I unlock a TracFone iPhone?', answer: 'Confirm TracFone controls the lock, gather the matching order and activation records, use its official device-unlock route and keep the request reference. Verify the result in Settings afterward.' },
      { question: 'How long does a TracFone iPhone unlock take?', answer: 'Use the current policy and device response instead of an old fixed number. Ask which policy applies, what event starts any required period and which condition remains for the specific IMEI.' },
      { question: 'Can TracFone unlock a bring-your-own iPhone?', answer: 'A bring-your-own iPhone may still be controlled by its original carrier or retailer. TracFone service does not automatically transfer another company’s unlock authority.' },
      { question: 'Why does TracFone say completed while my iPhone says SIM locked?', answer: 'Confirm that the approved IMEI matches the phone, keep it online, restart it and return to the same case if Carrier Lock does not update.' },
      { question: 'Can a service guarantee a TracFone iPhone unlock?', answer: 'No legitimate service can guarantee carrier approval or manufacture missing eligibility. It should identify its exact deliverable, limits and refund terms before payment.' },
    ],
  },
  {
    slug: 'iphone-unlocked-but-no-service-troubleshooting',
    title: 'iPhone Unlocked but No Service',
    heading: 'iPhone Unlocked but No Service: What to Check Next',
    description: 'Is your iPhone unlocked but no service appears? Separate carrier lock from account, SIM, eSIM, settings, coverage and device-status problems.',
    standfirst: 'No SIM restrictions rules out one cause, but the line still needs an active account, compatible device, correct provisioning and a working network connection.',
    published: '2026-09-24',
    updated: '2026-09-24',
    minutes: 9,
    topic: 'iPhone unlocked but no service',
    blocks: [
      { kind: 'p', text: 'If an iPhone is unlocked but no service, SOS or Searching appears, another carrier unlock request is usually not the next step. First confirm that Settings shows No SIM restrictions. Then work through the line, SIM or eSIM, account, carrier settings, coverage and device status in an order that preserves useful evidence.' },
      { kind: 'h2', id: 'key-takeaways', text: 'Key Takeaways' },
      { kind: 'list', items: [
        'No SIM restrictions means Carrier Lock is removed; it does not activate a mobile line.',
        'SOS means the iPhone is not connected to your own cellular network, even if emergency calling may be available.',
        'Ask the destination carrier to check the account, outage, plan, device block and IMEI or IMEI2 provisioning.',
        'For Dual SIM, confirm the intended line exists and is turned on before deleting or replacing an eSIM.',
        'A blacklist, incompatible model or hardware fault is not fixed by repeating the carrier unlock.',
      ] },
      { kind: 'h2', id: 'confirm-unlock-status', text: 'Confirm the iPhone is actually carrier-unlocked' },
      { kind: 'p', text: 'Open Settings, General, About and find Carrier Lock. Apple says No SIM restrictions means the iPhone is unlocked. If it says SIM locked, the original carrier still controls that restriction. If it already says No SIM restrictions, keep a screenshot and troubleshoot the destination line instead of submitting unrelated unlock requests.', links: [{ label: 'Follow Apple’s carrier-unlock instructions', href: 'https://support.apple.com/en-us/109316' }, { label: 'Use the full iPhone unlock-status guide', href: '/articles/how-to-check-if-iphone-is-unlocked' }] },
      { kind: 'table', head: ['What you see', 'Most useful interpretation', 'Who to contact first'], rows: [
        ['SIM locked in Carrier Lock', 'The carrier restriction remains', 'The carrier that controls the lock'],
        ['No SIM restrictions plus SOS or No Service', 'The unlock is complete; connection or line setup still fails', 'The destination carrier'],
        ['SIM Not Supported during activation', 'Activation may still see a carrier restriction or mismatched activation path', 'Original carrier, then Apple activation support'],
        ['Locked SIM, SIM PIN or PUK', 'The line credential is locked, not the iPhone’s carrier status', 'The SIM or eSIM issuer'],
        ['iPhone Locked to Owner', 'Activation Lock protects device ownership', 'The previous owner or Apple with valid proof'],
      ] },
      { kind: 'h2', id: 'first-recovery-steps', text: 'Try Apple’s first recovery steps' },
      { kind: 'p', text: 'Apple’s current No Service guidance recommends turning Airplane Mode on, waiting at least 15 seconds and turning it off, then restarting the iPhone. Update iOS, connect to Wi-Fi and open Settings, General, About to install a carrier-settings update if one is offered. These steps refresh the connection without erasing the device or deleting the eSIM.', links: [{ label: 'Follow Apple’s SOS, No Service and Searching guide', href: 'https://support.apple.com/en-us/120000' }] },
      { kind: 'list', ordered: true, items: [
        'Save the exact message, Carrier Lock result and time the failure began.',
        'Turn Airplane Mode on for at least 15 seconds, turn it off and restart the iPhone.',
        'Update iOS and check Settings, General, About for a carrier-settings update.',
        'Confirm the intended cellular line is present and turned on under Settings, Cellular.',
        'Test in a location where the destination carrier confirms coverage and no outage.',
        'Ask the carrier to verify the account, plan, device status and IMEI or IMEI2 provisioning.',
      ] },
      { kind: 'note', text: 'Do not delete an eSIM as a first experiment. Confirm that the carrier can reissue it and that you have a secure activation method before removing the only working profile or setup record.' },
      { kind: 'h3', id: 'dual-sim-esim', text: 'Check the correct line, IMEI and IMEI2' },
      { kind: 'p', text: 'Apple advises Dual SIM users to open Settings, Cellular, select the line and confirm Turn On This Line is enabled. If the line is missing, contact the carrier to set up the eSIM or insert the physical SIM. Give the carrier the IMEI or IMEI2 assigned to the line it is provisioning, not an identifier copied from a different slot or device.', links: [{ label: 'Review Apple’s cellular-line checks', href: 'https://support.apple.com/en-us/120000' }, { label: 'Troubleshoot an iPhone eSIM separately', href: '/articles/how-to-unlock-esim-on-iphone' }] },
      { kind: 'h3', id: 'physical-sim', text: 'Inspect a physical SIM without confusing the issue' },
      { kind: 'p', text: 'Remove and reseat the SIM only if the model uses a physical card and the tray closes properly. Apple recommends asking the carrier to test with another SIM if the card is damaged or does not fit. A replacement SIM can fix a defective line credential, but it does not change Carrier Lock or clear an IMEI block.' },
      { kind: 'h2', id: 'carrier-checks', text: 'Ask the destination carrier to check the network record' },
      { kind: 'p', text: 'Apple says the carrier should verify that the account is active and in good standing, the device is in a covered area without an outage, the correct cellular plan is present and the device is not blocked or barred from service. In countries that require IMEI registration, the carrier should also confirm that registration.', links: [{ label: 'See Apple’s carrier account checklist', href: 'https://support.apple.com/en-us/120000' }] },
      { kind: 'table', head: ['Carrier check', 'Why it matters', 'Useful evidence'], rows: [
        ['Line active and plan attached', 'An unlocked phone still cannot use a suspended or incomplete line', 'Account status and activation confirmation'],
        ['Coverage and outage', 'SOS or No Service can be local and temporary', 'Location, time and another device on the same network'],
        ['IMEI or IMEI2 provisioned', 'The line may be attached to the wrong device identifier', 'About-screen identifier and carrier activation record'],
        ['Device not blocked or barred', 'A blacklist or fraud bar is separate from Carrier Lock', 'Carrier case response or authoritative IMEI check'],
        ['Model and bands supported', 'An unlocked model is not automatically compatible everywhere', 'Exact model number and destination network requirements'],
      ] },
      { kind: 'h3', id: 'blacklist-not-unlock', text: 'A blacklist is not a carrier lock' },
      { kind: 'p', text: 'No SIM restrictions does not prove that the IMEI is clear. If the carrier says the device is blocked, identify which organization owns the report and use its legitimate review process. A factory reset, new eSIM or another unlock request will not remove a separate lost, stolen or fraud-related block.', links: [{ label: 'Compare blacklist and carrier-lock status', href: '/articles/blacklisted-iphone-unlock-carrier-lock-difference' }] },
      { kind: 'h2', id: 'international-use', text: 'If No Service started during international travel' },
      { kind: 'p', text: 'Confirm Data Roaming under Settings, Cellular, Cellular Data Options only if the plan allows roaming. If you installed a local or travel eSIM, verify that the correct line is on, selected for cellular data and provisioned for the right IMEI. Carrier unlock does not guarantee model compatibility, roaming access or a valid local plan.', links: [{ label: 'Use the international iPhone connectivity checklist', href: '/articles/unlock-iphone-for-international-use-travel-checklist' }] },
      { kind: 'h2', id: 'escalate', text: 'When to escalate to the carrier or Apple' },
      { kind: 'table', head: ['Evidence', 'Best escalation'], rows: [
        ['Carrier Lock still says SIM locked', 'Original carrier unlock team with the request reference'],
        ['No SIM restrictions, but carrier cannot see the IMEI', 'Destination carrier activation or provisioning team'],
        ['Line works in another phone, but no known-good line works in this iPhone', 'Apple diagnostics after carrier checks are documented'],
        ['Service stopped after repair or replacement', 'Carrier and repair provider with old-to-new IMEI mapping'],
        ['Only one location or period fails', 'Destination carrier coverage or outage support'],
      ] },
      { kind: 'p', text: 'Keep one timeline with screenshots, case references, the tested line, IMEI used and the result of each step. That prevents the carrier and device teams from repeating generic resets while the unresolved checkpoint remains visible.' },
      { kind: 'h2', id: 'avoid-destructive-steps', text: 'Avoid destructive steps until the account is checked' },
      { kind: 'list', items: [
        'Do not erase the iPhone merely to test an already confirmed No SIM restrictions result.',
        'Do not delete the only eSIM without confirming that the carrier can issue a replacement.',
        'Do not share passwords, one-time codes, a full IMEI or unredacted identity documents publicly.',
        'Do not pay for another carrier unlock when the destination carrier says the line or IMEI is not provisioned.',
        'Do not assume a successful Wi-Fi connection proves cellular hardware and antenna paths are working.',
      ] },
      { kind: 'cta', text: 'Have No SIM restrictions, the exact service message and a destination-carrier response? Send a redacted summary and ask whether iUnlockMobile currently offers relevant verification or assistance before ordering.', href: '/contact', label: 'Check service availability' },
    ],
    faq: [
      { question: 'Why does my unlocked iPhone say No Service?', answer: 'Carrier unlock removes one restriction but does not activate the line. Check coverage, account status, plan, SIM or eSIM setup, carrier settings, IMEI provisioning and whether the device is blocked.' },
      { question: 'Does No SIM restrictions mean the iPhone should work on every carrier?', answer: 'No. It confirms Carrier Lock is removed. The model must still be compatible, accepted, provisioned and attached to an active plan on the destination network.' },
      { question: 'Should I reset an unlocked iPhone that has No Service?', answer: 'Start with Airplane Mode, restart, iOS and carrier-settings updates, line checks and the carrier account review. Avoid erasing the phone or deleting an eSIM until recovery is confirmed.' },
      { question: 'Can a blacklisted iPhone show No SIM restrictions?', answer: 'Yes. Carrier Lock and an IMEI block are separate. An iPhone can be unlocked for other carriers while its IMEI is still blocked from network service.' },
      { question: 'Who should I contact when an unlocked iPhone has SOS?', answer: 'Contact the destination carrier first to check the account, outage, plan, block status and IMEI provisioning. Escalate to Apple after the carrier checks are documented and a known-good line still fails.' },
    ],
  },
  {
    slug: 'us-cellular-iphone-unlock-support-route',
    title: 'US Cellular iPhone Unlock Guide',
    heading: 'US Cellular iPhone Unlock: Which Support Route Applies?',
    description: 'Need a US Cellular iPhone unlock? Identify who controls the device record, prepare proof, request carrier action and verify the result.',
    standfirst: 'UScellular support now routes through T-Mobile, so the right unlock path depends on the device’s original sale, activation and current account record.',
    published: '2026-09-23',
    updated: '2026-09-23',
    minutes: 9,
    topic: 'US Cellular iPhone unlock',
    blocks: [
      { kind: 'p', text: 'A US Cellular iPhone unlock should start by identifying the system that owns the device record. The UScellular website now routes customers to T-Mobile, while an iPhone bought or activated before that transition may still have legacy purchase, financing or replacement history. Do not assume that a current T-Mobile line automatically rewrites the original unlock record.', links: [{ label: 'Open the current T-Mobile device-unlock support page', href: 'https://www.t-mobile.com/support/devices/unlock-your-mobile-wireless-device' }] },
      { kind: 'h2', id: 'key-takeaways', text: 'Key Takeaways' },
      { kind: 'list', items: [
        'Confirm where the iPhone was sold and first activated before choosing an unlock policy.',
        'Use the support account that currently displays the line, but preserve legacy UScellular records for the device.',
        'Paid off, eligible, request submitted and fully unlocked are four different statuses.',
        'Apple cannot approve a carrier unlock; the carrier controlling the lock must authorize it.',
        'Verify No SIM restrictions in Settings before buying a new SIM, eSIM or international plan.',
      ] },
      { kind: 'h2', id: 'identify-record-owner', text: 'Identify who controls the iPhone record' },
      { kind: 'p', text: 'The logo on the old receipt, the carrier shown on today’s bill and the organization that can change Carrier Lock may not be identical. Build a short device history before contacting support so the representative can search both the present account and any legacy record tied to the IMEI.' },
      { kind: 'table', head: ['Device history', 'Start with', 'Evidence to keep'], rows: [
        ['Bought from UScellular and still on a migrated account', 'The support route shown in the current account', 'UScellular order, activation and financing records plus the present account number'],
        ['Bought from UScellular but the line is closed', 'Current T-Mobile support with the legacy records', 'Final bill, payoff proof and the original device IMEI'],
        ['Brought to UScellular from another carrier', 'The carrier or retailer that originally locked it', 'Original receipt and that carrier’s account history'],
        ['Warranty or insurance replacement', 'The carrier or fulfiller that mapped the replacement', 'Document connecting the old IMEI to the replacement IMEI'],
        ['Bought second-hand', 'The seller and the carrier identified by the original record', 'Redacted receipt, current Carrier Lock screen and return deadline'],
      ] },
      { kind: 'note', text: 'Do not post a full IMEI, account PIN, password, one-time code, payment information or unredacted identity document. Share sensitive details only through an authenticated carrier channel.' },
      { kind: 'h3', id: 'check-carrier-lock', text: 'Check the Carrier Lock field first' },
      { kind: 'p', text: 'Open Settings, General, About and find Carrier Lock. Apple says No SIM restrictions means the iPhone is unlocked. If it says SIM locked, a carrier restriction remains. The field confirms the result but does not reveal which company owns the historical record or why a request is ineligible.', links: [{ label: 'Follow Apple’s current carrier-unlock instructions', href: 'https://support.apple.com/en-us/109316' }, { label: 'Compare reliable iPhone unlock checks', href: '/articles/how-to-check-if-iphone-is-unlocked' }] },
      { kind: 'h2', id: 'prepare-records', text: 'Prepare the records support will need' },
      { kind: 'table', head: ['Record', 'What it helps establish', 'What it cannot prove alone'], rows: [
        ['Original order or receipt', 'Seller, purchase date and sometimes IMEI', 'That every eligibility condition is complete'],
        ['Activation or first-service record', 'When the device entered the carrier system', 'That the service stayed qualifying afterward'],
        ['Payoff or final bill', 'Whether the device balance was cleared', 'That an unlock request was submitted'],
        ['Replacement confirmation', 'Why the active IMEI differs from the purchased phone', 'That the replacement inherited every status correctly'],
        ['Support case reference', 'Which team reviewed the request and when', 'That Carrier Lock has already updated on the iPhone'],
      ] },
      { kind: 'h3', id: 'policy-numbers', text: 'Do not rely on an old waiting-period number' },
      { kind: 'p', text: 'The current T-Mobile support page sends customers to the live Device Unlock Policy and provides account tools for checking eligibility. It does not publish a separate iPhone timeline for every legacy UScellular sale. Ask support which policy applies to the specific IMEI, which start event it uses and what requirement remains instead of importing a date from an old forum answer.', links: [{ label: 'Review the current T-Mobile unlock policy linked by support', href: 'https://www.t-mobile.com/responsibility/consumer-info/policies/sim-unlock-policy' }] },
      { kind: 'h2', id: 'request-steps', text: 'How to request a US Cellular iPhone unlock' },
      { kind: 'list', ordered: true, items: [
        'Record the exact Carrier Lock result, iPhone model and IMEI privately.',
        'Confirm the original seller, first activation carrier and whether the line now appears in a T-Mobile account.',
        'Gather the original order, activation history, payoff proof and any replacement-device mapping.',
        'Use the current support account to check device unlock status and eligibility.',
        'If the record is missing, ask support to search or escalate the legacy UScellular device history rather than opening unrelated requests.',
        'Get the request or case reference and ask whether the status is ineligible, eligible, submitted or completed.',
        'After completion, keep the iPhone online, restart it and check Carrier Lock again.',
      ] },
      { kind: 'p', text: 'Apple states that only the carrier can unlock an iPhone for use with another carrier and that a request can take time to complete. T-Mobile’s current iPhone instructions also direct eligible locked-iPhone users to support. There is no legitimate generic code that replaces this authorization.', links: [{ label: 'See T-Mobile’s iPhone unlock instructions', href: 'https://www.t-mobile.com/support/devices/unlock-your-mobile-wireless-device' }] },
      { kind: 'h2', id: 'status-troubleshooting', text: 'Troubleshoot the status in the right order' },
      { kind: 'table', head: ['What support says', 'What it means', 'Best next question'], rows: [
        ['No device record found', 'The present account may not contain the legacy sale or replacement mapping', 'Can the original order or old IMEI be searched and linked?'],
        ['Paid off but not eligible', 'Balance and unlock eligibility are separate checkpoints', 'Which exact policy condition remains?'],
        ['Eligible', 'The device can proceed, but a request may not exist yet', 'Was the iPhone unlock submitted and what is the reference?'],
        ['Completed, but Settings says SIM locked', 'The authorization may not have reached the iPhone or the wrong IMEI was handled', 'Which IMEI was approved, and has Apple’s activation system received it?'],
        ['No SIM restrictions, but the new line fails', 'Carrier Lock is no longer the likely cause', 'Is the destination carrier provisioning a compatible IMEI or IMEI2?'],
      ] },
      { kind: 'h3', id: 'used-iphone', text: 'If you bought the US Cellular iPhone used' },
      { kind: 'p', text: 'Keep return protection open while the seller provides a redacted original receipt and resolves any account-only requirement. A buyer usually cannot reconstruct missing ownership, payoff or replacement history. Do not impersonate the original account holder or pay an unexplained balance on a promise that the phone will unlock.', links: [{ label: 'Use the complete used-iPhone checklist', href: '/articles/checks-before-buying-a-used-phone' }] },
      { kind: 'h3', id: 'travel', text: 'If you need the unlock for travel' },
      { kind: 'p', text: 'Start before buying a travel eSIM. An eligibility estimate is not a completed unlock, and a second eSIM cannot bypass Carrier Lock. If the record cannot be resolved before departure, compare roaming or use a separate unlocked phone.', links: [{ label: 'Follow the pre-travel iPhone checklist', href: '/articles/unlock-iphone-for-international-use-travel-checklist' }] },
      { kind: 'h2', id: 'different-restrictions', text: 'Know what a carrier unlock will not fix' },
      { kind: 'list', items: [
        'A SIM PIN or PUK protects one SIM or eSIM and is handled by that line’s issuer.',
        'A forgotten iPhone passcode is a device-access problem, not a carrier-lock decision.',
        'iPhone Locked to Owner is Activation Lock tied to an Apple Account.',
        'A lost, stolen or fraud report requires the responsible carrier or account process.',
        'An unlocked iPhone can still be incompatible with another network or fail provisioning.',
      ] },
      { kind: 'p', text: 'A third-party service can help organize records or assist with a supported carrier request, but it cannot manufacture eligibility, rewrite legacy account history or bypass Apple ownership controls. Require a clear deliverable and refund terms before paying.', links: [{ label: 'Review what an IMEI unlock service can do', href: '/articles/imei-unlock-iphone-service-checklist' }] },
      { kind: 'cta', text: 'Have the original seller, activation history, Carrier Lock result and current support status? Send a redacted summary and ask whether a relevant iUnlockMobile service is available before ordering.', href: '/contact', label: 'Check service availability' },
    ],
    faq: [
      { question: 'How do I unlock a US Cellular iPhone now?', answer: 'Use the current T-Mobile support route, but keep the original UScellular purchase, activation, payoff and replacement records. Ask which policy controls the specific IMEI and retain the case reference.' },
      { question: 'Can T-Mobile unlock an old US Cellular iPhone?', answer: 'T-Mobile now provides the support route, but the device still needs a valid record and must satisfy the policy applied to its sale and activation. Ask support to locate any legacy UScellular history.' },
      { question: 'Is a paid-off US Cellular iPhone automatically unlocked?', answer: 'Not necessarily. A zero balance is one checkpoint. Confirm whether the device is eligible, whether a request was submitted and whether Settings shows No SIM restrictions.' },
      { question: 'Why does support say completed while my iPhone says SIM locked?', answer: 'Confirm that the approved IMEI matches the phone, keep it online, restart it and return to the same case if Carrier Lock does not update.' },
      { question: 'Can an unlock service guarantee approval for a US Cellular iPhone?', answer: 'No legitimate service can guarantee a carrier decision or create missing account history. It should identify the exact request it can support and provide written refund terms.' },
    ],
  },
  {
    slug: 'blacklisted-iphone-unlock-carrier-lock-difference',
    title: 'Blacklisted iPhone Unlock Guide',
    heading: 'Blacklisted iPhone Unlock: What Carrier Unlock Cannot Fix',
    description: 'A blacklisted iPhone unlock is not a carrier unlock. Check the IMEI, identify the report owner and use legitimate recovery or return routes.',
    standfirst: 'Carrier Lock and an IMEI block are separate controls. Removing one does not clear the other, and only the responsible record owner can correct a blacklist report.',
    published: '2026-09-23',
    updated: '2026-09-23',
    minutes: 9,
    topic: 'blacklisted iPhone unlock',
    blocks: [
      { kind: 'p', text: 'A blacklisted iPhone unlock is often described as one service, but it combines two different questions. Carrier unlock determines whether the iPhone may use other carriers. A blacklist or blocked-device record tells participating networks that the IMEI was reported, commonly as lost or stolen. An iPhone can be carrier-unlocked and still blocked from network access.' },
      { kind: 'h2', id: 'key-takeaways', text: 'Key Takeaways' },
      { kind: 'list', items: [
        'No SIM restrictions confirms carrier-unlock status; it does not prove that the IMEI is clean.',
        'A factory reset, new SIM or eSIM does not erase a carrier blacklist record.',
        'Use a carrier check or CTIA’s U.S. consumer checker to investigate an IMEI before buying used.',
        'The carrier or account responsible for the report must review a correction; a buyer cannot legitimately bypass it.',
        'If a seller cannot resolve the record, use the marketplace, payment and return protections while they remain open.',
      ] },
      { kind: 'h2', id: 'separate-restrictions', text: 'Separate the blacklist from other iPhone restrictions' },
      { kind: 'table', head: ['Restriction', 'What it controls', 'How to verify', 'Who can resolve it'], rows: [
        ['IMEI blacklist or device block', 'Whether participating networks accept the device', 'Carrier check or an authoritative lost-or-stolen device checker', 'The reporting carrier or legitimate account process'],
        ['Carrier Lock', 'Use with a different carrier', 'Settings > General > About > Carrier Lock', 'The carrier controlling the device lock'],
        ['Activation Lock', 'Ownership after erase or activation', 'The iPhone shows Locked to Owner', 'The previous owner or Apple with valid proof'],
        ['SIM PIN or PUK', 'Use of one SIM or eSIM line', 'Locked SIM, SIM PIN or PUK prompt', 'The issuer of that line'],
        ['Passcode', 'Access to the iPhone itself', 'Lock Screen asks for the device passcode', 'Apple’s supported passcode recovery process'],
      ] },
      { kind: 'note', text: 'Do not publish a full IMEI. Share it only with a trusted carrier, authoritative checker or transaction-support channel that needs it.' },
      { kind: 'h3', id: 'carrier-lock-check', text: 'Check Carrier Lock separately' },
      { kind: 'p', text: 'Apple says Settings, General, About shows No SIM restrictions when an iPhone is carrier-unlocked. Apple also states that only the carrier can authorize a carrier unlock. This status says nothing about a lost-or-stolen report attached to the IMEI, so both checks matter for a used device.', links: [{ label: 'Read Apple’s current carrier-unlock guidance', href: 'https://support.apple.com/en-us/109316' }, { label: 'Check whether an iPhone is unlocked', href: '/articles/how-to-check-if-iphone-is-unlocked' }] },
      { kind: 'h3', id: 'authoritative-imei-check', text: 'Use an authoritative IMEI check' },
      { kind: 'p', text: 'CTIA’s Stolen Phone Checker lets U.S. consumers check whether a used device has been reported lost or stolen. CTIA says the tool uses GSMA Device Check data, is limited to five free queries per day and is intended for U.S. consumers. Outside the United States, ask the relevant carrier or marketplace which authoritative device-status source applies.', links: [{ label: 'Open CTIA’s Stolen Phone Checker', href: 'https://www.stolenphonechecker.org/spc/consumer' }, { label: 'Learn what an IMEI check can and cannot tell you', href: '/articles/what-an-imei-check-tells-you' }] },
      { kind: 'h2', id: 'legitimate-resolution', text: 'Use the legitimate resolution route' },
      { kind: 'table', head: ['Your situation', 'Who should act', 'Evidence to prepare'], rows: [
        ['You reported your own iPhone lost and recovered it', 'The carrier or insurer used for the report', 'Account authentication, report or claim reference and current IMEI'],
        ['The carrier says the report is an error', 'The carrier team that owns the device record', 'Purchase proof, activation history and written case number'],
        ['You bought the iPhone from an individual', 'The seller should resolve the report; you protect the transaction', 'Listing, messages, receipt, IMEI result and return deadline'],
        ['You bought through a marketplace or retailer', 'Seller first, then marketplace or payment dispute support', 'Order, condition claim, seller response and authoritative check result'],
        ['Ownership or report source cannot be verified', 'Do not attempt a bypass', 'Preserve evidence and pursue return, dispute or appropriate local reporting'],
      ] },
      { kind: 'p', text: 'Ask the responsible carrier to identify the category of the block, the organization that placed it and the evidence required for review. Support may limit details for privacy or fraud prevention, so request a case number and a clear next action rather than another person’s account information.' },
      { kind: 'h2', id: 'buyer-action-plan', text: 'What a used-iPhone buyer should do' },
      { kind: 'list', ordered: true, items: [
        'Stop spending money on activation plans or unlock offers until the IMEI status is understood.',
        'Save the listing, seller messages, payment receipt, serial or IMEI evidence and the checker result with a timestamp.',
        'Ask the seller to contact the reporting carrier and provide a case reference without exposing private account details.',
        'Keep the marketplace return or buyer-protection deadline visible and escalate before it expires.',
        'If the seller disappears or the device may be stolen, follow the marketplace, payment provider and appropriate local reporting process.',
        'Recheck the IMEI only after the responsible carrier confirms that its review is complete.',
      ] },
      { kind: 'p', text: 'Do not let a seller delay you with a screenshot that only shows No SIM restrictions. That proves carrier-unlock status, not blacklist status. Also do not accept an IMEI result copied from before the sale; check the identifier on the actual device as close to the transaction as possible.', links: [{ label: 'Follow the full used-phone buying checklist', href: '/articles/checks-before-buying-a-used-phone' }] },
      { kind: 'h2', id: 'what-does-not-work', text: 'What does not remove a blacklist record' },
      { kind: 'list', items: [
        'Factory-resetting, erasing or restoring the iPhone does not alter a carrier IMEI report.',
        'Replacing a physical SIM or downloading an eSIM does not change the device identifier being checked.',
        'A completed carrier unlock does not remove a separate lost, stolen or fraud-related block.',
        'Changing region or using an international SIM is not proof that the record has been cleared and is not a legitimate resolution.',
        'Activation Lock removal and blacklist correction are unrelated ownership and network processes.',
      ] },
      { kind: 'h3', id: 'international-use', text: 'Will a blacklisted iPhone work abroad?' },
      { kind: 'p', text: 'Do not rely on that possibility. Carriers and device-status services can share data, and network acceptance varies. A phone connecting somewhere does not make the underlying ownership or report issue valid. Resolve the record or return the device before paying for travel service.' },
      { kind: 'h2', id: 'service-promises', text: 'Evaluate blacklist-removal promises carefully' },
      { kind: 'p', text: 'A legitimate third party may help interpret a status report, organize proof or communicate a supported case. It cannot lawfully impersonate an account holder, invent proof of ownership or guarantee that a carrier will reverse a valid report. Avoid sellers who request passwords or one-time codes, promise an untraceable bypass or refuse to identify the actual deliverable.' },
      { kind: 'list', items: [
        'Ask which organization controls the record and how the service is authorized to contact it.',
        'Require written eligibility limits, evidence requirements, timing assumptions and refund conditions.',
        'Pay with a method that provides dispute protection and keep every status message.',
        'Verify the result with the carrier or authoritative checker instead of relying on a completion email.',
      ] },
      { kind: 'cta', text: 'Have a redacted IMEI status, purchase proof, seller response and carrier case result? Send a summary and ask whether iUnlockMobile currently offers a relevant verification or assistance service before ordering.', href: '/contact', label: 'Check service availability' },
    ],
    faq: [
      { question: 'Can a blacklisted iPhone be carrier-unlocked?', answer: 'Carrier unlock and blacklist status are separate. A carrier may unlock network compatibility while the IMEI remains blocked. Both statuses must be checked independently.' },
      { question: 'Does No SIM restrictions mean the iPhone is not blacklisted?', answer: 'No. It confirms that Carrier Lock is removed. It does not confirm whether the IMEI has a lost, stolen or other carrier block.' },
      { question: 'Can a factory reset remove an iPhone blacklist?', answer: 'No. Erasing or restoring the iPhone does not change the carrier or device-status record associated with its IMEI.' },
      { question: 'Who can remove an incorrect blacklist report?', answer: 'Contact the carrier or organization responsible for the report through the legitimate account or ownership process. A used-device buyer may need the seller to act.' },
      { question: 'What should I do after buying a blacklisted iPhone?', answer: 'Preserve the listing and payment evidence, ask the seller to resolve the report, and use return, marketplace or payment protections before their deadlines.' },
    ],
  },
  {
    slug: 'total-wireless-iphone-unlock-policy-checklist',
    title: 'Total Wireless iPhone Unlock Guide',
    heading: 'Total Wireless iPhone Unlock: Which Policy Applies?',
    description: 'Need a Total Wireless iPhone unlock? Identify the right policy, verify the device record, submit the request and confirm Carrier Lock safely.',
    standfirst: 'The correct unlock path depends on who sold and activated the iPhone, which policy controls that record and what Total Wireless shows for the specific device.',
    published: '2026-09-22',
    updated: '2026-09-22',
    minutes: 9,
    topic: 'Total Wireless iPhone unlock',
    blocks: [
      { kind: 'p', text: 'A Total Wireless iPhone unlock should begin with the device record, not a waiting-period number copied from an old forum post. First establish whether Total Wireless sold and activated the iPhone or whether it was brought from another carrier. Then use the current official unlock route to check the rule and status attached to that IMEI.', links: [{ label: 'Open the official Total Wireless device-unlock page', href: 'https://www.totalwireless.com/device/device-unlock' }] },
      { kind: 'h2', id: 'key-takeaways', text: 'Key Takeaways' },
      { kind: 'list', items: [
        'A Total Wireless SIM in the phone does not prove that Total Wireless controls the iPhone’s carrier lock.',
        'Purchase date, activation date, paid-service history and the current device status answer different eligibility questions.',
        'A phone can be paid in full yet still need to satisfy the current policy linked to its original sale and activation.',
        'Use the official unlock portal or support channel for a device-specific decision instead of assuming an old timeline still applies.',
        'After approval, verify No SIM restrictions in Settings before buying another SIM or eSIM plan.',
      ] },
      { kind: 'h2', id: 'identify-policy-owner', text: 'Identify who controls the carrier lock' },
      { kind: 'p', text: 'Start with the seller and original activation path. An iPhone bought from Total Wireless may be governed by Total Wireless records. A bring-your-own iPhone can remain subject to the carrier or retailer that originally locked it. Moving service to Total Wireless does not transfer another company’s unlock authority.' },
      { kind: 'table', head: ['Device history', 'Likely policy owner', 'Best evidence'], rows: [
        ['Bought from Total Wireless and activated there', 'Total Wireless', 'Order, activation and service records tied to the same IMEI'],
        ['Brought to Total Wireless from another carrier', 'The original carrier or seller', 'Original purchase record and that carrier’s account history'],
        ['Bought second-hand', 'Depends on the original sale and activation', 'Seller’s redacted receipt plus a carrier-specific status response'],
        ['Replacement or warranty device', 'The carrier or fulfiller that mapped the replacement', 'Replacement confirmation showing old and new IMEI'],
      ] },
      { kind: 'note', text: 'Do not publish or send a full IMEI, account PIN, password, payment card or one-time code. Official support may need device details after authentication, but a public post does not.' },
      { kind: 'h3', id: 'check-carrier-lock', text: 'Read the iPhone’s Carrier Lock field' },
      { kind: 'p', text: 'Open Settings, General, About and find Carrier Lock. Apple says No SIM restrictions means the iPhone is unlocked. If it shows SIM locked, the carrier restriction remains. That field confirms the current result; it does not identify why a request is ineligible or which historical policy applies.', links: [{ label: 'Follow Apple’s current iPhone unlock instructions', href: 'https://support.apple.com/en-us/109316' }, { label: 'Compare four reliable unlock-status checks', href: '/articles/how-to-check-if-iphone-is-unlocked' }] },
      { kind: 'h2', id: 'build-device-timeline', text: 'Build the device timeline before requesting an unlock' },
      { kind: 'p', text: 'Policy language and cutoff dates can change. Instead of counting from whichever date is easiest to find, assemble the records that Total Wireless can match to the IMEI. This makes it possible to ask which rule applies and what requirement remains without guessing.' },
      { kind: 'table', head: ['Record', 'What it proves', 'What it does not prove'], rows: [
        ['Original receipt or order', 'Seller, purchase date and sometimes IMEI', 'The date qualifying service started'],
        ['Activation confirmation', 'When the device or line entered service', 'That every later day counted'],
        ['Service and payment history', 'Whether service stayed active under the account', 'That the unlock was requested or completed'],
        ['Unlock portal result or case reference', 'The carrier’s current decision for the device', 'That Settings has already received the update'],
      ] },
      { kind: 'h3', id: 'paid-in-full', text: 'Paid in full is only one checkpoint' },
      { kind: 'p', text: 'A zero device balance and unlock eligibility are not interchangeable. The live policy may also depend on where the phone was sold, how it was activated, service history, account standing or a fraud or loss record. Ask Total Wireless to name the unmet condition rather than accepting a vague “not eligible” answer.', links: [{ label: 'Review Total Wireless’s paid-in-full unlock FAQ', href: 'https://support.totalwireless.com/en/brands/General/TbVAccounthelp/faq/3104573/' }] },
      { kind: 'h2', id: 'request-steps', text: 'How to request a Total Wireless iPhone unlock' },
      { kind: 'list', ordered: true, items: [
        'Record the iPhone model, IMEI privately and the exact Carrier Lock result shown in Settings.',
        'Confirm the original seller and whether the device was activated as a Total Wireless purchase or brought from elsewhere.',
        'Collect the order date, activation date, service history and any replacement-device paperwork.',
        'Use the official Total Wireless unlock page to check the device and follow the current request instructions.',
        'If the result is unclear, ask which policy applies, what specific requirement remains and the date or event that will satisfy it.',
        'Keep the case reference. After completion, connect the iPhone to Wi-Fi or cellular service, restart it and check Carrier Lock again.',
      ] },
      { kind: 'p', text: 'Apple cannot approve the carrier request. Apple states that only the current carrier can unlock an iPhone for use with a different carrier, and the process can take time after submission. If Total Wireless says the request is complete but Settings still shows SIM locked, return to the same case with the current screenshot and timestamp.', links: [{ label: 'See Apple’s post-approval steps', href: 'https://support.apple.com/en-us/109316' }] },
      { kind: 'h2', id: 'status-troubleshooting', text: 'Troubleshoot the status without restarting the case' },
      { kind: 'table', head: ['Status or problem', 'Question to ask', 'Next action'], rows: [
        ['No eligibility date is shown', 'Which policy and start event are attached to this IMEI?', 'Request the device-specific requirement in writing.'],
        ['Paid off but marked ineligible', 'Which condition besides balance is not satisfied?', 'Compare the answer with the live policy and account record.'],
        ['Replacement iPhone is missing history', 'Was the old IMEI mapped to the replacement IMEI?', 'Provide the replacement confirmation through official support.'],
        ['Carrier says completed; Settings says SIM locked', 'Has the authorization reached Apple’s activation system?', 'Keep the phone online, restart and update the existing case.'],
        ['Settings says No SIM restrictions; new line fails', 'Is the new carrier provisioning the correct IMEI or IMEI2?', 'Troubleshoot compatibility and activation with the new carrier.'],
      ] },
      { kind: 'h3', id: 'used-iphone', text: 'You bought the Total Wireless iPhone used' },
      { kind: 'p', text: 'Ask the seller for a redacted original receipt, the current Carrier Lock screen and any unlock case reference while return protection is open. If the request requires verification from the original account, the seller may need to handle it. Do not impersonate an account holder or pay an unexplained balance on the promise that it will unlock the phone.', links: [{ label: 'Use the complete used-phone checklist', href: '/articles/checks-before-buying-a-used-phone' }] },
      { kind: 'h3', id: 'travel-deadline', text: 'You need the iPhone unlocked for travel' },
      { kind: 'p', text: 'Submit the check well before departure. An expected eligibility date is not a completed unlock, and a travel eSIM cannot bypass Carrier Lock. If the device will not qualify in time, compare roaming or use a separate unlocked device rather than buying a plan the iPhone cannot activate.', links: [{ label: 'Prepare your iPhone for international use', href: '/articles/unlock-iphone-for-international-use-travel-checklist' }] },
      { kind: 'h2', id: 'different-locks', text: 'Know what a carrier unlock will not fix' },
      { kind: 'list', items: [
        'A SIM PIN or PUK challenge protects a specific SIM or eSIM and is handled by the issuer of that line.',
        'A forgotten iPhone passcode is a device-access issue, not a Total Wireless carrier lock.',
        'iPhone Locked to Owner is Activation Lock tied to an Apple Account.',
        'A lost, stolen or fraud record needs resolution through the responsible account or carrier process.',
        'An unlocked iPhone can still be incompatible or refused activation by another network.',
      ] },
      { kind: 'p', text: 'A third-party service can help interpret records or assist with a supported request, but it cannot rewrite Total Wireless service history, override a fraud decision or bypass Apple ownership protection. Before paying, require the provider to identify the exact deliverable, evidence needed and refund conditions.', links: [{ label: 'Review an IMEI unlock service before paying', href: '/articles/imei-unlock-iphone-service-checklist' }] },
      { kind: 'cta', text: 'Have the original seller, activation record, Carrier Lock result and official case status? Send a redacted summary and ask whether a relevant iUnlockMobile service is currently available before ordering.', href: '/contact', label: 'Check service availability' },
    ],
    faq: [
      { question: 'How do I unlock a Total Wireless iPhone?', answer: 'Confirm that Total Wireless controls the lock, gather the purchase and activation records, and use its official device-unlock page for the policy and request tied to your IMEI. After approval, verify No SIM restrictions in Settings.' },
      { question: 'Is a Total Wireless iPhone unlocked when it is paid off?', answer: 'Not necessarily. A zero balance is one fact, but the applicable policy can also depend on the original seller, activation, service history, account status and device record.' },
      { question: 'Can Total Wireless unlock an iPhone brought from another carrier?', answer: 'Usually the carrier or retailer that controls the original lock must handle it. Ask Total Wireless to confirm the device is bring-your-own, then contact the original policy owner.' },
      { question: 'Why does Total Wireless say unlocked while my iPhone says SIM locked?', answer: 'Ask whether the request is merely eligible, submitted or fully completed. Keep the iPhone online, restart it and return to the same support case if Carrier Lock does not update.' },
      { question: 'Can an unlock service guarantee Total Wireless approval?', answer: 'No legitimate service can guarantee a carrier decision or create missing eligibility history. Verify the IMEI-specific policy first and require written deliverables and refund terms.' },
    ],
  },
  {
    slug: 'sim-locked-iphone-carrier-lock-or-sim-pin',
    title: 'SIM Locked iPhone: What It Means',
    heading: 'SIM Locked iPhone: Carrier Lock or SIM PIN?',
    description: 'A SIM locked iPhone can mean a carrier restriction or SIM PIN. Identify the exact message, contact the right provider and avoid lockouts.',
    standfirst: '“SIM locked” can describe two different protections. The words and location on screen determine whether you need the device carrier or the SIM issuer.',
    published: '2026-09-22',
    updated: '2026-09-22',
    minutes: 8,
    topic: 'SIM locked iPhone',
    blocks: [
      { kind: 'p', text: 'A SIM locked iPhone does not always need a carrier-unlock request. If Settings shows SIM locked next to Carrier Lock, the iPhone is restricted to a carrier. If the status bar says Locked SIM or the phone asks for a SIM PIN or PUK, the protection belongs to that SIM or eSIM. Choosing the wrong fix can waste time or permanently disable the line.' },
      { kind: 'h2', id: 'key-takeaways', text: 'Key Takeaways' },
      { kind: 'list', items: [
        'Carrier Lock: SIM locked is an iPhone network restriction; only the carrier that controls it can authorize removal.',
        'Locked SIM, SIM PIN and PUK refer to security on one physical SIM or eSIM; contact the issuer of that line.',
        'Never guess a SIM PIN or PUK because repeated wrong entries can make the SIM or eSIM unusable.',
        'SIM Not Supported can point to a carrier restriction or activation problem, so check Carrier Lock before deciding.',
        'Passcode lock, Activation Lock and lost-device records require different owners and recovery paths.',
      ] },
      { kind: 'h2', id: 'read-exact-message', text: 'Read the exact message and where it appears' },
      { kind: 'table', head: ['What you see', 'What it usually means', 'Who can resolve it'], rows: [
        ['Settings > General > About > Carrier Lock: SIM locked', 'The iPhone is restricted to a carrier', 'The carrier that controls the device lock'],
        ['Locked SIM in the status bar', 'SIM PIN protection activated after restart or SIM removal', 'The carrier that issued that SIM or eSIM'],
        ['Enter SIM PIN or Enter PUK', 'The line credential is required; PUK may follow failed PIN attempts', 'The SIM or eSIM issuer'],
        ['SIM Not Supported during activation', 'Possible carrier restriction or activation mismatch', 'Check Carrier Lock, then the relevant carrier'],
        ['iPhone Locked to Owner', 'Activation Lock linked to an Apple Account', 'The legitimate owner through Apple’s process'],
      ] },
      { kind: 'note', text: 'Stop entering codes if you do not know them. Apple warns that guessing a SIM PIN or PUK can permanently lock the SIM or eSIM and require a replacement.' },
      { kind: 'h3', id: 'carrier-lock-field', text: 'If Carrier Lock says SIM locked' },
      { kind: 'p', text: 'Open Settings, General, About. Apple says No SIM restrictions next to Carrier Lock means the iPhone is unlocked. If it says SIM locked, identify the original or current carrier that holds the restriction and ask for its eligibility requirements. Apple cannot submit or approve this request.', links: [{ label: 'Read Apple’s carrier-unlock guidance', href: 'https://support.apple.com/en-us/109316' }, { label: 'Check carrier-unlock eligibility step by step', href: '/articles/iphone-carrier-unlock-eligibility' }] },
      { kind: 'h3', id: 'locked-sim-status', text: 'If the status bar says Locked SIM' },
      { kind: 'p', text: 'A SIM PIN protects cellular use on one physical SIM or eSIM. Apple says the line locks after a restart or after the SIM is removed when SIM PIN is enabled. This does not prove that the iPhone itself is carrier-locked, and replacing or unlocking the line credential does not change the Carrier Lock field.', links: [{ label: 'Follow Apple’s SIM PIN and PUK instructions', href: 'https://support.apple.com/en-us/118228' }] },
      { kind: 'h2', id: 'safe-decision-tree', text: 'Use this safe decision tree' },
      { kind: 'list', ordered: true, items: [
        'Take a screenshot of the exact message, but redact phone numbers, account data and the full IMEI before sharing it.',
        'Open Settings, General, About and record the Carrier Lock result.',
        'If Carrier Lock says SIM locked, identify the carrier controlling the device and review that carrier’s current unlock policy.',
        'If the status bar says Locked SIM or a SIM PIN or PUK is requested, stop guessing and contact the issuer of that line.',
        'If the message is SIM Not Supported, check Carrier Lock first, then confirm that the new carrier is provisioning a compatible IMEI or IMEI2.',
        'After the correct provider confirms resolution, restart the iPhone and verify the relevant status again.',
      ] },
      { kind: 'h2', id: 'carrier-unlock-route', text: 'For a carrier-locked iPhone' },
      { kind: 'p', text: 'Collect the IMEI privately, original seller, purchase and activation dates, account standing, payoff record and any prior case number. Ask the carrier whether the device is eligible, whether a request was submitted and whether the authorization is complete. These are separate stages, and “approved” does not always mean the phone has received the change yet.' },
      { kind: 'table', head: ['Stage', 'Evidence to keep', 'Useful question'], rows: [
        ['Policy check', 'Live policy and device history', 'Which rule applies to this IMEI?'],
        ['Eligibility review', 'Written unmet condition or eligibility date', 'What exact requirement remains?'],
        ['Request submitted', 'Case or request reference', 'When should the status be checked again?'],
        ['Carrier says completed', 'Completion message and current Carrier Lock screen', 'Has the authorization reached Apple’s activation system?'],
      ] },
      { kind: 'p', text: 'Do not look for a generic iPhone network-unlock code. Apple says only the carrier can unlock the iPhone, and Settings is the clearest on-device confirmation. If No SIM restrictions appears but a new line still fails, move to compatibility, provisioning or SIM/eSIM troubleshooting.', links: [{ label: 'See what an IMEI unlock service can actually do', href: '/articles/imei-unlock-iphone-service-checklist' }] },
      { kind: 'h2', id: 'sim-pin-route', text: 'For a SIM PIN or PUK lock' },
      { kind: 'p', text: 'Contact the carrier that issued the physical SIM or eSIM. Apple advises using that carrier’s default SIM PIN only when it is known from official documentation; otherwise, do not guess. The issuer can provide the supported PIN or PUK path. If the phone says PUK exhausted or the credential cannot unlock the line, request a replacement SIM or eSIM.', links: [{ label: 'Verify Apple’s current SIM PIN warning', href: 'https://support.apple.com/en-us/118228' }] },
      { kind: 'h3', id: 'dual-sim', text: 'Dual SIM can show two different line states' },
      { kind: 'p', text: 'On an iPhone with Dual SIM or Dual eSIM, each line can have its own issuer and SIM PIN state. In Settings, Cellular, select the affected line before changing SIM PIN settings. A working second line does not prove that the locked line is fixed, and neither line’s PIN status proves the phone is carrier-unlocked.' },
      { kind: 'h2', id: 'nearby-errors', text: 'Do not confuse these nearby errors' },
      { kind: 'table', head: ['Restriction', 'Protects or controls', 'Correct route'], rows: [
        ['iPhone passcode', 'Access to the device', 'Apple’s passcode recovery process'],
        ['Activation Lock', 'Ownership through an Apple Account', 'Previous owner or Apple with valid proof'],
        ['Carrier Lock', 'Use with other mobile networks', 'The carrier controlling the device lock'],
        ['SIM PIN or PUK', 'Use of one SIM or eSIM line', 'The issuer of that line'],
        ['Lost, stolen or fraud record', 'Network or account risk controls', 'The reporting carrier or legitimate account holder'],
      ] },
      { kind: 'p', text: 'A factory reset does not create carrier eligibility, remove Activation Lock or recover a blocked SIM credential. Diagnose the named restriction first. If you bought the iPhone used, keep return protection open until the seller proves both ownership and the carrier-lock status.', links: [{ label: 'Handle iPhone Locked to Owner legitimately', href: '/articles/iphone-locked-to-owner-legitimate-fixes' }, { label: 'Follow the used-iPhone checks before paying', href: '/articles/checks-before-buying-a-used-phone' }] },
      { kind: 'h2', id: 'before-paying', text: 'Before paying anyone to fix “SIM locked”' },
      { kind: 'list', items: [
        'Require the provider to name the exact restriction and the organization that must approve it.',
        'Do not share account passwords, one-time codes, payment PINs or an unredacted identity document.',
        'Reject promises to bypass Activation Lock, manufacture carrier eligibility or remove a lost-device record without the responsible account.',
        'Get the deliverable, expected evidence, refund conditions and support route in writing.',
        'Verify the result in Settings or with the issuing carrier instead of relying on a completion email alone.',
      ] },
      { kind: 'cta', text: 'Know the exact message, Carrier Lock result, carrier and line issuer? Send a redacted summary and ask whether a relevant iUnlockMobile service is currently available before ordering.', href: '/contact', label: 'Check service availability' },
    ],
    faq: [
      { question: 'What does SIM locked mean on an iPhone?', answer: 'In the Carrier Lock field, SIM locked means the iPhone is restricted to a carrier. In the status bar, Locked SIM usually means a SIM PIN protects that physical SIM or eSIM.' },
      { question: 'How do I unlock a SIM locked iPhone?', answer: 'First check where the message appears. Contact the device-lock carrier for Carrier Lock, or the line issuer for a SIM PIN or PUK. Do not guess codes.' },
      { question: 'Is a SIM PIN the same as a carrier lock?', answer: 'No. A SIM PIN protects one SIM or eSIM line. Carrier Lock restricts the iPhone’s use with other networks and requires carrier authorization.' },
      { question: 'What should I do if my iPhone asks for a PUK?', answer: 'Stop entering codes and contact the carrier that issued the affected SIM or eSIM. If the PUK is exhausted, Apple says you may need a replacement SIM or eSIM.' },
      { question: 'Does resetting an iPhone remove SIM locked?', answer: 'A reset does not satisfy a carrier policy, remove Activation Lock or recover a permanently blocked SIM. Identify the restriction and use its official recovery route.' },
    ],
  },
  {
